...
label_t = Label(root, text='RELATIVIDAD', font=('Helvetica', 50), bg='light blue')
...
img1 = PhotoImage(file='imgs1\\6.png')
img2 = PhotoImage(file='imgs1\\7.png')
img3 = PhotoImage(file='imgs1\\8.png')
img4 = PhotoImage(file='imgs1\\9.png')
img5 = PhotoImage(file='imgs1\\10.png')
count = 0
