...
def minijuego_1():
    ...
    BULLET_FIRE_SOUND = pygame.mixer.Sound('minijuego_1\\Gun+Silencer.mp3')
    #BULLET_HIT_SOUND = pygame.mixer.Sound('Grenade+1.mp3')
    BULLET_HIT_SOUND = pygame.mixer.Sound('minijuego_1\\Grenade+1.mp3')
    ...
    YELLOW_SPACESHIP_IMAGE = pygame.image.load('minijuego_1\\spaceship_yellow.png')
    ...
    RED_SPACESHIP_IMAGE = pygame.image.load('minijuego_1\\spaceship_red.png')
    ...
    SPACE = pygame.transform.scale(pygame.image.load('minijuego_1\\space.png'),(WIDTH,HEIGHT))
