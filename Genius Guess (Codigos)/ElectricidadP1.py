...
label_t = Label(root, text='ELECTRICIDAD Y MAGNETISMO', font=('Helvetica', 50), bg='light blue')
label_t.place(x=200, y=50)
...
img1 = PhotoImage(file='imgs1\\16.png')
img2 = PhotoImage(file='imgs1\\17.png')
img3 = PhotoImage(file='imgs1\\18.png')
img4 = PhotoImage(file='imgs1\\19.png')
img5 = PhotoImage(file='imgs1\\20.png')
count = 0
