...
label_t = Label(root, text='ASTRONOMÍA', font=('Helvetica', 50), bg='light blue')
label_t.place(x=450, y=50)
...
img1 = PhotoImage(file='imgs1\\11.png')
img2 = PhotoImage(file='imgs1\\12.png')
img3 = PhotoImage(file='imgs1\\13.png')
img4 = PhotoImage(file='imgs1\\14.png')
img5 = PhotoImage(file='imgs1\\15.png')
count = 0
